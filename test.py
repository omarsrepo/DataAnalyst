...
class ActionTableCommunicate:
    ...
    def create_table(self, table_id: str, cols_info: tuple[dict[str, str], dict[str, str]] = None,):
        schema = {
            "id": table_id,
            "cols": [{"id": k, "dtype": v} for k, v in cols_info[0].items()] + [{"id": k, "dtype": v} for k, v in cols_info[1].items()],
        }
        ...
        #     "accept": "application/json",
        #     "content-type": "application/json",
        #     "authorization": "Bearer jamai_sk_51cd630a71c10c1d68d56812a9dbcf468c21e01076a3e674",
        #     "X-PROJECT-ID": "proj_7bcb34f8831154cb0657c396"
        # }
        #
    ...
    return {
        ...
        "messages": [
            ...
            },
            {
                ...
                + f"{column_name}. If the information is null, just output null. Format the list into lowercase string separated by comma. \nOnly output the string separated by comma, not list, do not include any other information.",
            },
        ],
        "functions": [],
        "function_call": "auto",
